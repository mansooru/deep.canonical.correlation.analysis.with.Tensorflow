...
def GraphNet_regularizer(scale, scope=None):
  """Returns a function that can be used to apply GraphNet regularization to weights.
  GraphNet regularization encourages weight simmilar within high connectivity node.
  Args:
    scale: A scalar multiplier `Tensor`. 0.0 disables the regularizer.
    scope: An optional scope name.
  Returns:
